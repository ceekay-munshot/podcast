...
function footer(): string {
  return `<tr><td style="background:${C.navy};padding:18px 36px;border-top:1px solid #9c7b2e;">
      ...
      <p style="font-family:${SANS};font-size:11px;color:#7d8ba3;margin:10px 0 0;">You're receiving this because you subscribed to the Munshot Weekly Brief. Manage it from your <a href="${MUNS_DASHBOARD}" style="color:${C.goldSoft};">Munshot dashboard</a>'s weekly-brief bell.</p>
    </td></tr>`
}
